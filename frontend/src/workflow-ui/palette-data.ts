        ...
        groups: [
            ...
            },
            {
                ...
                components: [
                    ...
                    src('teradata', 'Teradata', 'available', 'Read from Teradata through its ADBC driver (Teradata-branded wrapper over the ADBC reader). Point at a Teradata ADBC driver shared library; friendly host / user / password / database fields map onto ADBC options. Whole-table read or custom SQL.'),
        ...
        groups: [
            ...
            },
            {
                ...
                components: [
                    ...
                    snk('teradata', 'Teradata', 'available', 'Write to Teradata through its ADBC driver using bulk ingest (Teradata-branded wrapper over the ADBC ingest sink). Point at a Teradata ADBC driver shared library. Append creates the table if missing then appends; Overwrite replaces it.'),
